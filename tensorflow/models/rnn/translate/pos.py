...
_buckets = [(5,5), (10,10), (15,15), (20,20), (25,25), (30,30), (35,35), (40,40), (45,45), (50,50)]
...
def train():
  ...
  en_train, fr_train, en_dev, fr_dev, _, _ = data_utils.prepare_pos_data(
...
def evaluate_sentence(model, sess):
    ...
    en_vocab_path = os.path.join(FLAGS.data_dir,
                                 "vocab%d.txt" % FLAGS.en_vocab_size)
    fr_vocab_path = os.path.join(FLAGS.data_dir,
                                 "vocab%d.tags" % FLAGS.fr_vocab_size)
...
def decode():
  ...
  with tf.Session() as sess:
    ...
    test_file_path = os.path.join(FLAGS.data_dir,
                                 "test_pos.txt")
